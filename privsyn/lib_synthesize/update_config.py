...
from privsyn.lib_synthesize.records_update import RecordUpdate


class UpdateConfig:
    def __init__(self, domain, num_records, update_config, init_df=None):
        self.update = RecordUpdate(domain, num_records, init_df)
